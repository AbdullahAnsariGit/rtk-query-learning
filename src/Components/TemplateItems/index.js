...
const TemplateItem = ({item, index, numColumns, onPress}) => {
  ...
  const renderDailyTaskForm = () => {
    return (
      <View style={{position: 'relative'}}>
        ...
        <SyneRegular text={'Due Date'} style={{fontSize: 12}} />
        <SpaceLine />
        <View style={[styles.fieldContainer, styles.contentField]}>
          <SyneRegular text={'MM-DD-YYYY'} style={styles.text} />
          <MyIcons
            name={'calendar'}
            size={13}
        ...
        <View style={styles.row}>
          <SyneRegular text={'Category'} style={{fontSize: 12}} />
          <SyneRegular text={'*'} style={{color: colors.text.red}} />
        </View>
        <SpaceLine />
        <View style={[styles.fieldContainer, styles.contentField]}>
          <SyneRegular text={'Please Select'} style={styles.text} />
          <MyIcons
            name={'downArow'}
            size={13}
            stroke={colors.input.background}
        ...
        <SpaceLine />
        <View style={styles.row}>
          <SyneRegular text={'Task'} style={{fontSize: 12}} />
          <SyneRegular text={'*'} style={{color: colors.text.red}} />
        </View>
        <SpaceLine />
  ...
  const renderWorkOutForm = () => {
    return (
      <View style={{position: 'relative'}}>
        {item.selected && checkMark()}
        <SpaceLine style={styles.spaceLine} />
        <SyneRegular text={'Exercise'} style={{fontSize: 12}} />
        <View style={styles.fieldContainer} />
        <SpaceLine style={styles.spaceLine} />
        <SyneRegular text={'Intensity'} style={{fontSize: 12}} />
        <View style={styles.row}>
          <MyIcons name={'star'} />
          <MyIcons name={'star'} />
          <MyIcons name={'star'} />
        ...
        <SpaceLine style={styles.spaceLine} />
        <SyneRegular text={'Reps'} style={{fontSize: 12}} />
        <View style={[styles.fieldContainer, styles.contentField]}>
          <SyneRegular text={'ex.23'} style={styles.text} />
        </View>
      </View>
    );
  };
  ...
  return (
    <TouchableOpacity style={[styles.templateBox, itemStyle]} onPress={()=> onPress(item)}>
      <SyneBold text={item.title} style={{fontSize: 16}} numberOfLines={2} />
